...
station_to_region = {
    ...
    "IDCJDW2111": "Hunter",
    "IDCJDW2144": "Wollongong", 
    "IDCJDW2801": "Canberra"
}

# Updated to include Feb 2025 through Feb 2026 (13 months to ensure full coverage)
months = [
...
weather_df.to_csv("datasets/weather/year_weather_dataset.csv", index=False)
